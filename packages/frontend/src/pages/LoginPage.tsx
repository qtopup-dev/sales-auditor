  ...
  return (
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 flex items-center justify-center px-4">
      <div className="w-full max-w-[400px] p-6 sm:p-8 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm bg-white dark:bg-gray-800">
        ...
        <h1 className="text-2xl font-semibold text-gray-900 dark:text-gray-100">Sales Auditor</h1>
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1 mb-6">Sign in to your account</p>

        <form onSubmit={handleSubmit(onSubmit)} noValidate>
          {/* Username field */}
          <div className="mb-4">
            <label htmlFor="username" className="text-sm text-gray-500 dark:text-gray-400 block mb-1">
              Username
            </label>
            <input
              id="username"
              ...
              className={`h-10 w-full border rounded-md px-3 py-2 text-sm bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-0 disabled:opacity-50 disabled:cursor-not-allowed ${
                errors.username
          ...
          {/* Password field */}
          <div className="mb-6">
            <label htmlFor="password" className="text-sm text-gray-500 dark:text-gray-400 block mb-1">
              Password
            </label>
            <input
              id="password"
