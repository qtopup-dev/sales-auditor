  ...
  return (
    ...
    >
      ...
      <input
        ...
        readOnly
        value={tempPassword}
        className="w-full border border-gray-200 dark:border-gray-600 rounded-md px-3 py-2 text-sm text-gray-900 dark:text-gray-100 bg-gray-50 dark:bg-gray-900 font-mono select-all tracking-wider mb-3"
