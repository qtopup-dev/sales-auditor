...
### Phase 999.1: fix: Add Row Catalog Lag — Complete (2026-06-24)
...
- [x] 999-01-01-PLAN.md — Backend: new catalogRouter (GET /catalog/products + GET /catalog/mops, no requireRole) mounted on protectedRouter
- [x] 999-01-02-PLAN.md — Frontend: SalesPage pre-fetch + AddRowForm + EditableCell updated to read from React Query cache
